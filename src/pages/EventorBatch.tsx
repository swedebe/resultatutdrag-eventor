...
const EventorBatch = () => {
  ...
  return (
    <div className="container py-8">
      ...
      <Card className="mb-6">
        <CardHeader>
          <CardTitle>{texts.eventorbatch_options_title || "Bearbetningsalternativ"}</CardTitle>
          <CardDescription>{texts.eventorbatch_options_description || "Välj vilka data som ska hämtas och med vilken fördröjning"}</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="fetch-course-length">{texts.eventorbatch_fetch_course_length || "Hämta banlängder (direkt Node.js fetch)"}</Label>
